...
- *ART* — витвори мистецтва, як от `Пересопницьке Євангеліє`, `Мона Ліза`, `Let it Be` ("казка «Вовк і семеро козенят" — тут сутність — це `Вовк і семеро козенят` без слова казка), а також продукти: `iPhone`, `Tesla Model S Plaid`, `Мівіна`, `Містер Мускул`.
