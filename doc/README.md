...
- *DATE* — повні та неповні календарні дати (сторіччя, рік, місяць, день). Наприклад: `10.12.1999 р.`, `2014 році`, `червні цього року`, `вісімнадцятому сторіччі`, `минулого року`, `квітні`. Слово "рік" є частиною дати, якщо воно присутнє. Прийменники не є частиною дати, тобто у фразі "у 2015 році" виділяємо лише `2015 році`.
